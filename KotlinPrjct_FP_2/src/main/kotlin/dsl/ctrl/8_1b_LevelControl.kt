...
class LevelController(levelInp : Var<Double>, stopOut: Var<Boolean>, pumpOut : Var<Boolean>) : StateModel<States>() {

    private var pump : Boolean by pumpOut
    private var level : Double by levelInp
    private var stop : Boolean by stopOut
...
object TankSystem : StateModel<TankSystemState>() {
    ...
    val ctrl = LevelController(levelInp = levelVar, stopOut = stopVar, pumpOut = pumpVar)
